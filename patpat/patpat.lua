...
function pings.patpat(a, b, c)
  ...
  if b then -- block
     ...
     success, noPats, noHearts = pcall(avatarVars["petpet.playerHead"], myUuid, config.holdFor, blockPos.x, blockPos.y, blockPos.z)
     ...
     -- call petpet function
     success, noPats, noHearts = pcall(avatarVars["petpet"], myUuid, config.holdFor)
  ...
  -- spawn particles
  noHearts = success and rawequal(noHearts, true) or avatarVars['patpat.noHearts']
