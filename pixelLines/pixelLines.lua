...
lineWorld.preRender = function()
   ...
   for _, line in pairs(lines) do
      ...
      if pos1.z > 1 and pos2.z > 1 and pos1.xy > lineScreenMin and pos2.xy > lineScreenMin and pos1.xy < lineScrenMax and pos2.xy < lineScrenMax then -- cull lines
         ...
         local depth1 = mathAbs(vectorsToCameraSpace(line.pos1).z) * 16 -- depth from worldToScreenSpace wont work here
         local depth2 = mathAbs(vectorsToCameraSpace(line.pos2).z) * 16 -- thats why im using vectors.toCameraSpace for depth
